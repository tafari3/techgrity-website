...
Produce and approve the remaining 12 authoritative master-page visuals in this order:
...
1. master-visual approval register and reference assets;
2. final factual-input decisions;
3. final production copy and legal review;
4. implementation architecture and deployment plan;
5. implementation and integration tests;
6. responsive, accessibility, SEO, security and performance evidence;
7. public deployment and commissioning evidence.
